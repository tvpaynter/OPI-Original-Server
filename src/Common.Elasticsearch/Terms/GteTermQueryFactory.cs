...
{
    public sealed class GteTermQueryFactory : ITermQueryFactory
    {
        ...
        public QueryBase GetQuery(string field, object value, Type dataType)
        {
            ...
            switch (typeCode)
            {
                ...
                case TypeCode.Int64:
                    ...
                    {
                        Field = field,
                        GreaterThanOrEqualTo = Convert.ToInt64(value)
                    };
                ...
                case TypeCode.DateTime:
                    ...
                    {
                        Field = field,
                        GreaterThanOrEqualTo = Convert.ToString(value)
                    };
                ...
                default:
                    throw new ElasticSearchTermException(
                        $"Type :{propertyType.PropertyType.Name} of property {field} does not supported");
            }
        }
    }
}